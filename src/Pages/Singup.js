    ...
    <Wrapper>
      <div className="container">
        <div className="buttons">
          ...
          <span className={value === "login" ? "span log" : "span sing"}>
           
          </span>
        </div>
        <div className="inputs">
          <div className={value==="singup"?"logininputs translate":"logininputs"}>
          ...
          <div className={value==="login"?"singupinputs translatesingup":"singupinputs"}>
            <form onSubmit={(e) => singup(e)} className="form">
            <h3 style={{textAlign:"center"}}>Explore The New Notes World</h3>
            <div>
